    ...
    <div class="row align-items-center">
        <div class="col-lg-6">
            ...
            <?php if(auth()->guard()->guest()): ?>
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light">Đăng ký miễn phí</a>
            <?php else: ?>
...
<div class="card shadow-sm p-4 mb-5" style="margin-top: -40px; position:relative; z-index:10;">
    ...
    <form action="<?php echo e(auth()->check() ? route('customer.dashboard') : route('login')); ?>" method="GET">
...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-4">
        <div class="card p-4 h-100 border shadow-sm" style="border-radius:1rem;">
            ...
            <a href="<?php echo e(auth()->check() ? route('customer.dashboard') : route('login')); ?>"
