...
<nav class="navbar navbar-expand-lg bg-white border-bottom shadow-sm">
    <div class="container">
        <a class="navbar-brand text-primary" href="<?php echo e(url('/')); ?>"><?php echo e(config('app.name')); ?></a>
                    ...
                    <?php if($role === 'driver'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('driver.dashboard') ? 'active-page' : ''); ?>"
                               href="<?php echo e(route('driver.dashboard')); ?>">Lịch chạy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('driver.profile*') ? 'active-page' : ''); ?>"
                               href="<?php echo e(route('driver.profile')); ?>">Hồ sơ tài xế</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if($role === 'operator'): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('operator.drivers*') ? 'active-page' : ''); ?>"
                               href="<?php echo e(route('operator.drivers')); ?>">Danh sách tài xế</a>
                        </li>
                    <?php endif; ?>
...
<footer class="bg-dark text-secondary mt-5 py-4 border-top">
    <div class="container">
        <div class="row g-4">
            <div class="col-md-6">
                <h6 class="text-white fw-bold mb-2"><?php echo e(config('app.name')); ?></h6>
                <p class="small mb-0">Nền tảng đặt vé xe khách liên tỉnh cao cấp.</p>
            </div>
            <div class="col-md-6">
                <h6 class="text-white fw-bold mb-2">Liên hệ</h6>
                <p class="small mb-1">Hotline: <?php echo e(config('app.contact_phone')); ?></p>
                <p class="small mb-0">Email: <?php echo e(config('app.contact_email')); ?></p>
            </div>
        </div>
        <hr class="border-secondary mt-4">
        <p class="small text-center mb-0">© <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved.</p>
    </div>
</footer>
