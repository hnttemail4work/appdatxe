...
<div class="row g-4">
    ...
    <div class="col-12">
        <div class="card shadow-sm p-4">
            <h5 class="card-title-bar mb-3">Danh sách tài xế (<?php echo e($drivers->count()); ?>)</h5>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-bottom">
                                    ...
                                    <td class="text-muted small"><?php echo e($d->user->phone ?? '—'); ?></td>
                                    <td><span class="badge bg-primary">Hạng <?php echo e($d->license_class); ?></span></td>
                                    <td><?php echo e($d->experience_years); ?> năm</td>
                                    <td><?php echo e($d->operator?->name ?? '—'); ?></td>
                                    <td>
                                        <form method="POST" action="<?php echo e(route('admin.users.status', $d->user)); ?>"
                                              class="d-flex gap-1 align-items-center">
                                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                            <select name="status" class="form-select form-select-sm" style="width:120px">
                                                <?php $__currentLoopData = ['active','inactive','suspended']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($st); ?>" <?php echo e($d->user->status === $st ? 'selected' : ''); ?>>
                                                        <?php echo e(match($st){ 'active'=>'Hoạt động','inactive'=>'Không HĐ','suspended'=>'Tạm ngưng' }); ?>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-secondary"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#edit-drv-<?php echo e($d->id); ?>">Sửa</button>
                                    </td>
                                </tr>
                                <tr class="collapse" id="edit-drv-<?php echo e($d->id); ?>">
                                    <td colspan="8" class="bg-light">
                                        <div class="p-2">
                                            
                                            <small class="fw-semibold text-muted d-block mb-1">Thông tin tài khoản</small>
                                            <form method="POST" action="<?php echo e(route('admin.users.update', $d->user)); ?>"
                                                  class="row g-2 mb-3">
                                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                <div class="col-md-3">
                                                    <label class="form-label mb-0 small">Họ tên</label>
                                                    <input type="text" name="name" value="<?php echo e($d->user->name); ?>" class="form-control form-control-sm" required>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label mb-0 small">Email</label>
                                                    <input type="email" name="email" value="<?php echo e($d->user->email); ?>" class="form-control form-control-sm" required>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin.drivers.update', $d)); ?>"
                                                  class="row g-2">
                                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select name="operator_id" class="form-select form-select-sm">
                                                        ...
                                                        <?php $__currentLoopData = $operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($op->id); ?>" <?php echo e($d->operator_id == $op->id ? 'selected':''); ?>><?php echo e($op->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label mb-0 small">Ghi chú</label>
                                                    <input type="text" name="notes" value="<?php echo e($d->notes); ?>" class="form-control form-control-sm">
                                                </div>
                                                <div class="col-md-2 d-flex align-items-end">
